...
use ChrisReedIO\APIAmigo\Resources\AmigoRecordingResource\Pages;
use ChrisReedIO\APIAmigo\Resources\AmigoRecordingResource\RelationManagers;
use Filament\Forms;
...
class AmigoRecordingResource extends Resource
{
    ...
    {
        return [
            'index' => Pages\ListAmigoRecordings::route('/'),
            // 'create' => Pages\CreateAmigoRecording::route('/create'),
            'view' => Pages\ViewAmigoRecording::route('/{record}'),
